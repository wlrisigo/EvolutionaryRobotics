...
class ROBOT:
    ...
    def send_objects(self ,sim):
        ...
        #                       length = 10,width =3,height = .000001,
        #                        collision_group = 'Env',
        #                       r = .5,g = .5,b = .5 )
    ...
    def send_sensors( self,sim ):
        ...
        self.Bot=sim.send_position_sensor( body_id = self.O0 )

        self.BallP=sim.send_position_sensor(  body_id = self.B1 )

        self.BallL=sim.send_light_sensor( body_id = self.B1 )
